...
// The rate card editor. Lives in the Services tab; also reachable at /RateCard.
...
export default function RateCardPanel({ showHeading = true }) {
  ...
  if (isLoading || !draft) {
    return <div className="py-8 text-gray-400">Loading the rate card…</div>;
  }
  ...
  return (
    <div className="space-y-6">
      {showHeading && (
        <div>
          <h2 className="text-xl font-bold text-gray-800">Rate card</h2>
