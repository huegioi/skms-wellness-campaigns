...
export default function EscalationInfographic() {
  ...
  return (
    <div className="bg-mf-cream rounded-xl p-4 mb-5">
      <p className="text-xs uppercase tracking-widest text-mf-ink-3 mb-3">The Cost of Inaction — Pre-Patient Escalation</p>
      <div className="flex items-stretch">
        <div className="flex-1 text-center px-1">
          ...
          <p className="text-[11px] font-bold text-mf-ink leading-tight">{stages[0].label}</p>
          <p className="text-[9px] text-mf-ink-2 mt-1 leading-tight">{stages[0].desc}</p>
        </div>
        <div className="flex flex-col items-center justify-start px-1 shrink-0">
          <div className="w-0.5 h-9 bg-mf-plum" />
          <div className="bg-mf-plum text-white text-[8px] font-bold px-2 py-1 rounded-full whitespace-nowrap mt-1">
            SkillfulMeans
          </div>
        </div>
        <div className="flex-1 text-center px-1">
          ...
          <p className="text-[11px] font-bold text-mf-ink leading-tight">{stages[1].label}</p>
          <p className="text-[9px] text-mf-ink-2 mt-1 leading-tight">{stages[1].desc}</p>
        </div>
        ...
        <div className="flex-1 text-center px-1">
          ...
          <p className="text-[11px] font-bold text-mf-ink leading-tight">{stages[2].label}</p>
          <p className="text-[9px] text-mf-ink-2 mt-1 leading-tight">{stages[2].desc}</p>
        </div>
      </div>
    </div>
  );
