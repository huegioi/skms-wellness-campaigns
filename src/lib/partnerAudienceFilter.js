 ...
 * that would appear in the Partners list/pipeline are included. Dead/lost leads
 * and inactive referral partners are excluded.
 *
...
export function isExcludedFromAllPartners(r) {
  if (r._sourceType === 'lead') return isDeadLead(r);
