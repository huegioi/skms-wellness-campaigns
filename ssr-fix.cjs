...
// src/components/fitnessroi/ScenarioRange.jsx
var import_react = __toESM(require_react(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var fmtUSD = (v) => "$" + Math.round(v).toLocaleString();
var FILL = {
  base: "#0f766e",
  optimistic: "#14b8a6",
...
function ScenarioRange({ scenarios, showInvestment = false }) {
  ...
  const rows = eligible.filter((s) => !s.exceedsCeiling).slice().sort((a, b) => a.annualSavings - b.annualSavings);
  if (!rows.length) return null;
  const max = Math.max(...rows.map((r) => r.annualSavings)) || 1;
  const byKey = Object.fromEntries(rows.map((r) => [r.scenario, r]));
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-sm font-semibold text-[#4a2040] mb-1", children: "Three numbers, not one" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs text-stone-500 leading-relaxed mb-4", children: "Most wellbeing programmes are sold with a single confident figure. We\u2019d rather show you what we\u2019d plan against, what we\u2019d expect, and where the ceiling sits." }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "space-y-2.5", children: rows.map((r) => {
      const pct = Math.max(3, r.annualSavings / max * 100);
      const outlined = r.scenario === "expected";
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-baseline justify-between mb-1", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "text-xs font-semibold text-[#4a2040]", children: [
            r.label,
            outlined && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ml-1.5 font-normal text-[10px] text-stone-400", children: "with every commitment in place" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "text-xs font-bold text-[#0f766e] tabular-nums", children: [
            fmtUSD(r.annualSavings),
            showInvestment && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "ml-1.5 font-normal text-stone-400", children: [
              "on ",
              fmtUSD(r.investment)
            ] })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-2.5 rounded-full bg-stone-100 overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "div",
          {
            ...
            style: {
              ...
              backgroundColor: outlined ? "rgba(74,32,64,0.08)" : void 0
            }
          }
        ) })
      ] }, r.scenario);
    }) }),
    withheld.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs text-stone-500 leading-relaxed mt-4", children: "There is a more optimistic case, and we\u2019ve left it out. At your numbers it lands above anything published for a programme run across a whole workforce, so we don\u2019t think it\u2019s a number you should plan around." }),
    byKey.base && byKey.expected && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-xs text-stone-500 leading-relaxed mt-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { className: "text-stone-700", children: fmtUSD(byKey.base.annualSavings) }),
      " is the number we\u2019d hold ourselves to.",
      " ",
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { className: "text-stone-700", children: fmtUSD(byKey.expected.annualSavings) }),
      " is what we\u2019d expect with all four commitments in place.",
      byKey.optimistic && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { className: "text-stone-700", children: fmtUSD(byKey.optimistic.annualSavings) }),
        " is the work landing about as well as it does anywhere."
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs text-stone-500 leading-relaxed mt-3", children: "All three move with the choices above \u2014 those decide how many of your people the programme actually reaches, and reach decides everything after it." })
  ] });
}

// src/components/fitnessroi/dashboard/ScenarioRangeChart.jsx
var import_react2 = __toESM(require_react(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var fmtUSD2 = (v) => "$" + Math.round(v).toLocaleString();
var FILL2 = {
  conservative: "#a8a29e",
  base: "#0f766e",
...
function ScenarioRangeChart({ scenarios, headcount = 0 }) {
  const rows = scenarios?.all || [];
  if (!rows.length) return null;
  const max = Math.max(...rows.map((r) => r.annualSavings)) || 1;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-baseline justify-between mb-1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { className: "text-sm font-semibold text-[#4a2040]", children: "Scenario range" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-[10px] text-stone-400", children: "ascending by effect size" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-xs text-stone-500 leading-relaxed mb-4", children: "Expected holds Base Case effect sizes and varies delivery only \u2014 the four no-cost conditions met, reach sustained, capacity purchased to match \u2014 which is why it is outlined and why its investment is higher. Conservative is internal only; clients see Base Case, Expected and Optimistic." }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "space-y-3", children: rows.map((r) => {
      const pct = Math.max(2, r.annualSavings / max * 100);
      const outlined = r.scenario === "expected";
      const reached = headcount ? Math.round(headcount * r.reach) : null;
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-baseline justify-between gap-3 mb-1", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "text-xs font-semibold text-[#4a2040]", children: [
            r.label,
            !r.clientFacing && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "ml-1.5 text-[10px] font-normal uppercase tracking-wider text-stone-400", children: "internal" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "text-[11px] text-stone-400 tabular-nums shrink-0", children: [
            Math.round(r.reach * 100),
            "% reach",
            reached != null && ` \xB7 ${reached.toLocaleString()} people`,
            " \xB7 ",
            fmtUSD2(r.investment),
            " invested",
            " \xB7 ",
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("b", { className: "text-stone-600", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex-1 h-3 rounded-full bg-stone-100 overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "div",
            {
              className: "h-full rounded-full",
              style: {
                width: `${pct}%`,
                background: FILL2[r.scenario],
                border: outlined ? "1.5px dashed #4a2040" : "none"
              }
            }
          ) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-xs font-bold text-[#4a2040] tabular-nums w-24 text-right shrink-0", children: fmtUSD2(r.annualSavings) })
        ] }),
        r.exceedsCeiling && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-[10px] text-[#b45309] mt-1", children: "\u26A0 above the ceiling of research-based effect \u2014 withheld from the client view" })
      ] }, r.scenario);
    }) }),
    rows.some((r) => r.overCapacity) && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "text-[11px] text-[#b45309] mt-3 leading-relaxed", children: [
...
// src/components/fitnessroi/dashboard/BenchmarkChart.jsx
var import_react3 = __toESM(require_react(), 1);
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
function BenchmarkChart({ scenarios }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h3", { className: "text-sm font-semibold text-[#4a2040] mb-1", children: "Against published benchmarks" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-xs text-stone-500 leading-relaxed mb-4", children: "Year-one return per dollar. The dashed line is the ceiling of research-based effect \u2014 the highest ROI any credible published source reports for a whole-population workplace programme." }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "space-y-1.5 mb-4", children: marks.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "group", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-baseline justify-between gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-[11px] text-stone-500", children: m.label }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-[11px] text-stone-400 tabular-nums shrink-0", children: [
            m.v.toFixed(2),
            ":1"
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "h-1.5 rounded-full bg-stone-100 overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "h-full rounded-full bg-stone-300", style: { width: `${x(m.v)}%` } }) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-[10px] text-stone-400 leading-snug mt-0.5 hidden group-hover:block", children: m.note })
      ] }, i)) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "pt-3 border-t border-stone-100 space-y-1.5", children: ours.map((o, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-baseline justify-between gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: `text-[11px] font-semibold ${o.dim ? "text-stone-400" : "text-[#4a2040]"}`, children: [
            o.label,
            o.dim && " \xB7 internal"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-[11px] tabular-nums shrink-0 font-semibold text-[#0f766e]", children: [
            o.v.toFixed(2),
            ":1"
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "relative h-1.5 rounded-full bg-stone-100 overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "div",
          {
            className: "h-full rounded-full",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "relative h-4 mt-1.5", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "span",
      {
...
// base44/shared/rateCard.ts
var RATE_CARD_DEFAULTS = {
  // Workshops
  workshopFirstSession: 1500,
  // includes recording + materials
  workshopExtraSession: 1200,
  // = first session − the $300 materials component
  ...
  attendanceRate: 0.25,
  // share of employees who show up
  maxAttendeesPerSession: 250,
  // engagement cap → 1,000 employees per session
  // 14-day challenges
  challengeEngagementRate: 0.2,
  // share of headcount given slots
  challengeMinSlots: 40,
  // Leadership EQ
  leqSeries: 1e4,
  // three-workshop series, flat
  leqCoachingRatePerHour: 1200,
  // per group, per hour
  leqCoachingHours: 3,
  // hours in one coaching block
  leqMaxLeadersPerGroup: 12,
  leqLcpPerLeader: 1250,
  // LCP assessment + individual session
  leqLeaderRate: 5e-3,
  // 0.50% of headcount are leaders
  ...
  leqSingleWorkshop: 3500,
  // one of the three series workshops, sold alone
  leqCoachingSession: 450,
  // Leadership EQ Coaching Program, per session
  // Wellness boxes
  wellnessBox: 100,
  // blended average across the brochure range
...
var RATE_CARD = { ...RATE_CARD_DEFAULTS };
var CHALLENGE_TIER_DEFAULTS = () => [
  ...
  { min: 1e3, max: Infinity, price: 9 }
];
var WELLNESS_BOX_DEFAULTS = {
  reduceStress: 65,
  relaxationSleep: 65,
  largeEmotional: 100,
...
var CLASS_PRICE_DEFAULTS = {
  mindfulMovement: 2e3,
  yogaStress: 2e3,
  mindfulnessClasses: 1800
};
var CHALLENGE_TIERS = CHALLENGE_TIER_DEFAULTS();
var SMOOTH_CHALLENGE_BANDS = true;
var WELLNESS_BOX_PRICES = { ...WELLNESS_BOX_DEFAULTS };
var CLASS_PRICES = { ...CLASS_PRICE_DEFAULTS };
var CAMPAIGN_STAGES = [
  {
    stage: 1,
    name: "Spark",
    publicInBuilder: true,
    tagline: "Suddenly a different way is possible.",
  ...
  },
  {
    ...
    name: "Momentum",
    publicInBuilder: true,
    tagline: "Change you can see, and start to count on.",
  ...
  },
  {
    ...
    name: "Resilience",
    publicInBuilder: true,
    tagline: "New habits that hold under pressure.",
...
function sessionsPerWorkshop(headcount) {
  const hc = Number(headcount) || 0;
  const perSession = RATE_CARD.maxAttendeesPerSession / RATE_CARD.attendanceRate;
  return Math.max(1, Math.ceil(hc / perSession));
}
function workshopTopicPrice(headcount) {
...
function challengePrice(headcount) {
...
function boxCountFor(tier, headcount) {
  const sections = sessionsPerWorkshop(headcount);
  return RATE_CARD.boxesPerWorkshopSection * tier.workshops * sections + RATE_CARD.boxesPerChallenge * tier.challenges;
}
function leadershipEqPrice(headcount, opts = {}) {
  ...
  return {
    ...
    lcpRounds,
    coachingHours,
    series: RATE_CARD.leqSeries,
    coaching,
    lcp
  };
}

// base44/shared/journeyModel.ts
var ENGAGEMENT = [0.25, 0.4, 0.55, 0.65, 0.8, 1];
var STAGES = CAMPAIGN_STAGES.map((s, i) => ({
  num: s.stage,
  name: s.name,
...
function calcInvestment(stage, N) {
...
var RESEARCH_MODEL = {
  ...
  effects: {
    presenteeism: { conservative: 0.05, base: 0.2, optimistic: 0.3 },
    absenteeism: { conservative: 0, base: 0.1, optimistic: 0.15 },
    turnover: { conservative: 0, base: 0.05, optimistic: 0.1 },
    medical: { conservative: 0, base: 1, optimistic: 1.6 }
  },
  costBases: {
  ...
  benchmarks: [
    { v: 0, label: "Illinois / Song & Baicker / Fleming", note: "Three RCTs, ~86,000 employees, up to three years. No significant effect on employment outcomes." },
    ...
    { v: 4.1, label: "Deloitte UK, reactive", note: "Support after someone is already struggling." },
    { v: 4.2, label: "Deloitte UK, proactive", note: "Targeted at identified at-risk groups." },
    { v: 4.7, label: "Deloitte UK, average", note: "36 ROIs pooled from 26 studies. The 2022 edition headline was 5:1; this is the 2024 figure." },
    { v: 6.3, label: "Deloitte UK, universal", note: "Whole-population interventions, by stage of intervention. Deloitte reports 5.2:1 for the same category in a second table, by recipient group size, and pooled only ROIs reported as statistically significant." }
  ],
...
function participationFrom(conditions = {}, base2 = RESEARCH_MODEL.participation.base) {
  const b = Math.min(0.9, Math.max(1e-3, base2));
  let odds = b / (1 - b);
  for (const [key, or] of Object.entries(RESEARCH_MODEL.participation.or)) {
    ...
    if (always || conditions[key]) odds *= or;
  }
  return Math.min(0.95, odds / (1 + odds));
}
function participationAtFullDelivery(base2) {
  return participationFrom(
    { optOut: true, workday: true, noCost: true, teamLeader: true, raffle: true },
    base2
  );
}
function pricedCapacity(stage, N) {
  if (!(N > 0)) return 0;
  const tier = CAMPAIGN_STAGES.find((s) => s.stage === stage.num) || CAMPAIGN_STAGES[0];
  const seats = tier.workshops > 0 ? sessionsPerWorkshop(N) * RATE_CARD.maxAttendeesPerSession : 0;
  const slots = tier.challenges > 0 ? challengeSlots(N) : 0;
  return Math.min(1, Math.max(seats, slots) / N);
}
function investmentAt(stage, N, participation) {
  const tier = CAMPAIGN_STAGES.find((s) => s.stage === stage.num) || CAMPAIGN_STAGES[0];
  const reached = Math.max(0, N * participation);
  const sessions = tier.workshops > 0 ? Math.max(1, Math.ceil(reached / RATE_CARD.maxAttendeesPerSession)) : 0;
  const topicPrice = RATE_CARD.workshopFirstSession + Math.max(0, sessions - 1) * RATE_CARD.workshopExtraSession;
  const slots = tier.challenges > 0 ? Math.max(RATE_CARD.challengeMinSlots, Math.round(reached)) : 0;
  const raw = slots * challengeRatePerPerson(slots);
  const cheaperUpBand = CHALLENGE_TIERS.filter((t) => t.min > slots).map((t) => t.min * t.price);
  const perChallenge = cheaperUpBand.length ? Math.min(raw, ...cheaperUpBand) : raw;
  const leq = tier.leadershipEQ ? leadershipEqPrice(N, { coachingBlocks: tier.coachingBlocks, lcpRounds: tier.lcpRounds }).total : 0;
  const boxes = RATE_CARD.boxesPerWorkshopSection * tier.workshops * Math.max(1, sessions) + RATE_CARD.boxesPerChallenge * tier.challenges;
  return tier.workshops * topicPrice + tier.challenges * perChallenge + leq + boxes * RATE_CARD.wellnessBox;
}
var SCENARIO_META = {
  conservative: {
    label: "Conservative",
...
function dosePoints(stage) {
  const d = RESEARCH_MODEL.dose;
  return stage.workshops * d.workshop + stage.challenges * d.challenge + (stage.leq ? d.leadershipEq : 0) + (stage.groupCoaching ? d.groupCoaching : 0) + (stage.indivCoaching ? d.individualCoaching : 0);
}
function runScenario(inputs, scenario) {
  ...
  const reach = isExpected ? participationAtFullDelivery(inputs.participBase) : inputs.participRate;
  const investment = isExpected ? investmentAt(stage, N, reach) : calcInvestment(stage, N).total;
  const D = 1 - Math.exp(-dosePoints(stage) / RESEARCH_MODEL.dose.saturation);
  const WC = 1 + (stage.leq ? RESEARCH_MODEL.dose.wcLeadershipEq : 0) + (stage.groupCoaching ? RESEARCH_MODEL.dose.wcGroupCoaching : 0);
  const k = D * WC;
  const eKey = scenario === "expected" ? "base" : scenario;
...
function runScenarios(inputs) {
  const keys = ["conservative", "base", "expected", "optimistic"];
...
var TYPICAL_BANDS = Object.fromEntries(
...
var base = {
  ...
  turnoverRate: 0.15,
  absDays: 4.2,
  participRate: participationFrom({ optOut: true, workday: true }),
  stageNum: 3,
  wellnessFund: 0
};
var hot = runRoi({ ...base, stressRate: 0.41 }).scenarios;
var norm = runRoi({ ...base, stressRate: 0.3 }).scenarios;
var card = (t, inner) => `<div style="background:#fff;border:1px solid #e7e5e4;border-left:4px solid #0f766e;border-radius:16px;padding:24px;margin-bottom:20px">
...
import_fs.default.writeFileSync("/app/ssr-fix.html", `<!doctype html><html><head><meta charset="utf-8">
...
${card("Buyer view \xB7 optimistic breaches ceiling (withheld)", (0, import_server.renderToString)(/* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ScenarioRange, { scenarios: hot })))}
${card("Buyer view \xB7 normal case (all three shown)", (0, import_server.renderToString)(/* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ScenarioRange, { scenarios: norm })))}
${card("Dashboard \xB7 scenario range", (0, import_server.renderToString)(/* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ScenarioRangeChart, { scenarios: hot, headcount: 1e3 })))}
${card("Dashboard \xB7 benchmarks", (0, import_server.renderToString)(/* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BenchmarkChart, { scenarios: hot })))}
</div></body></html>`);
console.log("ok");
